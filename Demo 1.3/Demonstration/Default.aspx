					...
					<main id="contentbar">
						<div class="article">
							...
							<p>ZooPhy is a public health informatics application for phylogeography of zoonotic RNA viruses . The intended users of ZooPhy are health agencies, agriculture agencies, wildlife agencies, and any other researcher interest in surveillance of zoonotic diseases in either animals or humans. Phylogeography of viruses, such as zoonotic viruses (animal-human transmission) can support public health and disease surveillance. For example, it can help epidemiologists answer questions such as ‘For a particular geographical area and timeframe:
                                ...
                                ZooPhy's <b>BEAST</b> (Bayesian Evolutionary Analysis by Sampling Trees) software provides researchers access to advanced data analysis. Users can produce phylogeographic tree models of virus evolution, Bayesian skyline plots for population genetics analysis, and create future virus and disease behavior projections.<br /> </p>
								<p>Once live, ZooPhy will be freely available to the public with the hope that it will help enhance population surveillance of human and animal zoonotic diseases and inform public health decision making.
							</p>
						</div>
					</main>
